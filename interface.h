...
#include "proto/state.pb.h"						//! Protobuf: pacote gerado pelo state.proto
#include "proto/command.pb.h"						//! Protobuf: pacote gerado pelo command.proto
#include "proto/debug.pb.h"						//! Protobuf: pacote gerado pelo debug.proto
