...
void OriginalDebugDrawer::draw(){

}

void OriginalDebugDrawer::setData( Pose *actPose, Pose *stepPose, Pose *finalPose, Path *path, ColorName teamColor, ColorName robotColor ){
	this->stepPose = stepPose;
...
void OriginalDebugDrawer::drawDebugStepRobot(){
	glPushMatrix();
